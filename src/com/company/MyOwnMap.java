...
import com.company.util.DefaultNotSupportedMap;
import com.company.util.DefaultNotSupportedSet;


//Взял реализацию у Дмитрия Ивановича
public class MyOwnMap<K, V> implements DefaultNotSupportedMap<K, V> {
    ...
    private class EntryListItem implements Map.Entry<K, V> {
        ...
        EntryListItem(K key, V value, EntryListItem next) {
            this.key = key;
            this.value = value;
            this.next = next;
        }
